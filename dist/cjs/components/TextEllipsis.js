...
var TextEllipsis = function (_a) {
    ...
    var Wrapper = as;
    return ((0, jsx_runtime_1.jsx)(Wrapper, __assign({ className: "multiline-ellipsis ".concat(className !== null && className !== void 0 ? className : ""), style: { WebkitLineClamp: lineClamp, direction: dir } }, rest, { children: children })));
};
